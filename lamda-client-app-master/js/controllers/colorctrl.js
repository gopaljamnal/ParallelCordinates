...
angular.module('LAMDAClientApp.controllers')
  .controller('ColorCtrl', function ($scope, R, Color, DataSet) {
    ...
    function updateVariables(schema) {
      ...
      // if manual selection option exists, make sure that it is on top
    ...
    function applySchemaInformation(schema) {
      ...
      if (d.initialSchemaLoad) {
        ...
        $scope.colorVariable = _.find(schema, { 'name': 'FACILITY_COST' });
