...
angular.module('LAMDAClientApp.directives')
  .directive('detailChartDirective', [
    function (  ) {
      "use strict";
      return {
        restrict: 'E',
        ...
        link: function (scope, element, params) {
          ...
          var createChart = function() {
            ...
            if(barData.length) {
              ...
              var vlData = {
                ...
                "encoding": {
                  "x": {"field": selectedLabelField, "type": "ordinal","axis":{"title":selectedLabelField},  "sort": { "field": "sortOrder"}},
                  "y": {"field": barChartAttribute, "type": "quantitative","axis":{"title":barChartAttribute}}
                 // "color": {"field": "color", "type": "quantitative", "legend":null,
              ...
              var vegaView = null;
              if(scope.model.useExistingColorScheme){
                vlData.encoding["color"] = {"field": "color", "scale": null}
              }
              ...
              var handleBrush = function (evt, data) {
                ...
                if (data) {
                  ...
                  var ids = data.values[0];
                  //console.log(JSON.stringify(data.values));
                  if(ids.length >3 ) {
                    console.log(JSON.stringify(data));
                    scope.highlightItems(data.values[0])
          ...
          scope.$on('chartDataUpdated', function() {
              createChart();
            });
